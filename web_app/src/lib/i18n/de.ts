...
export const de: Lang = {
  ...
  msg: {
    ...
    'menu.f.username.searching': 'suche …',
    'menu.f.username.no_hits': 'kein Spieler gefunden',
    'menu.f.username.level': 'Level {0}',
    'menu.f.username.pick': 'Vorschlag wählen — lädt gleich die Werte',
